        ...
        <footer className="flex justify-center">
            <div className="container-footer px-10 mb-[30px] text-[#888888]">
                <div className="first-footer md:flex">
                    ...
                    <div className="basis-2/6 flex flex-col md:items-center md:mx-10 mt-5">
                        <p className='title font-semibold text-[#292929] text-xl mb-2'>Other Products</p>
                        <a className='hover:text-[#292929] hover:font-semibold duration-200 mb-1'
                    ...
                    <div className="basis-2/6 md:flex flex-col items-end mt-5">
                ...
                <div className="flex flex-col items-center">
                    <div className="flex relative bottom-[28px] bg-darken-white px-10">
                        <a className="m-3" href='mailto:nguyentrunglong.150903@gmail.com'>
                        ...
                        <a className="m-3" href='https://www.facebook.com/nguyentrunglong.LoDtus/'>
                            <svg className='w-[30px] h-[30px] fill-[#888888] hover:fill-[#292929] duration-200' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path d="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5V334.2H141.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H287V510.1C413.8 494.8 512 386.9 512 256h0z"/>
                            </svg>
                        </a>
                        <a className="m-3" href='https://www.instagram.com/__nguyentrunglong__/'>
                        ...
                        <a className="m-3" href='https://www.linkedin.com/in/nguyentrunglong/'>
                            <svg className='w-[30px] h-[30px] fill-[#888888] hover:fill-[#292929] duration-200' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/>
                            </svg>
                        </a>
                        <a className="m-3" href='https://github.com/LoDtus'>
                    ...
                    <div className="flex h-fit relative bottom-[10px]">
