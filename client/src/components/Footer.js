            ...
            <div className="container-footer px-10 mb-[30px] text-[#888888]">
                <div className="first-footer md:flex">
                    <div className="about-footer basis-2/6 mt-5">
                        <p className='title font-semibold text-black text-xl mb-2'>Project: Text Editor</p>
                        ...
                        <span className='text-black font-semibold'>Source Code: </span>
                        <a className='underline underline-offset-2 hover:text-black duration-200' href='https://github.com/LoDtus/document-editing-and-management-application'>here</a>
                    </div>

                    <div className="otherProducts-footer basis-2/6 flex flex-col md:items-center md:mx-10 mt-5">
                        <p className='title font-semibold text-black text-xl mb-2'>Other Products</p>
                        <a
                            className='hover:text-black hover:font-semibold duration-200 mb-1'
                    ...
                    <div className="informations-footer basis-2/6 md:flex flex-col items-end mt-5">
                        <p className="title font-semibold text-black text-xl mb-2">Informations</p>
                ...
                <div className="second-footer flex flex-col items-center">
                    <div className="contact-footer flex relative bottom-[28px] bg-darken-white px-10">
                        <a className="gmail-contact-footer m-3" href='mailto:nguyentrunglong.150903@gmail.com'>
                            <svg className='w-[30px] h-[30px] fill-[#888888] hover:fill-black duration-200' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <a className="ig-contact-footer m-3" href='https://www.instagram.com/__nguyentrunglong__/'>
                            <svg className='w-[30px] h-[30px] fill-[#888888] hover:fill-black duration-200' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <a className="github-contact-footer m-3" href='https://github.com/LoDtus'>
                            <svg className='w-[30px] h-[30px] fill-[#888888] hover:fill-black duration-200' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
